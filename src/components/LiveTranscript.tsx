...
const styles = StyleSheet.create({
  ...
  item: { marginBottom: 12, padding: 14, backgroundColor: '#FFFFFF', borderRadius: 16, borderLeftWidth: 3, borderLeftColor: '#FCDDD4', elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 3 },
  itemHighlighted: { backgroundColor: '#FFF5EE', borderLeftColor: '#E8573E', borderLeftWidth: 4 },
  ...
  patternBadge: { marginTop: 8, paddingVertical: 4, paddingHorizontal: 10, backgroundColor: '#FFF0EB', borderRadius: 8, alignSelf: 'flex-start' },
  patternBadgeText: { fontSize: 11, color: '#E8573E', fontWeight: '600' },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32 },
  emptyIconCircle: { width: 80, height: 80, borderRadius: 28, backgroundColor: '#FFF0EB', justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
